...
interface IconCheckoutProps {
  color?: string;
  size?: number;
}

const IconClock: React.FC<IconCheckoutProps> = ({
  color = "#1A1A1A",
  size = 24,
}) => {
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 5.25C12.4142 5.25 12.75 5.58579 12.75 6V12H16.5C16.9142 12 17.25 12.3358 17.25 12.75C17.25 13.1642 16.9142 13.5 16.5 13.5H12C11.5858 13.5 11.25 13.1642 11.25 12.75V6C11.25 5.58579 11.5858 5.25 12 5.25Z"
        fill={color}
      />
    </svg>
  );
