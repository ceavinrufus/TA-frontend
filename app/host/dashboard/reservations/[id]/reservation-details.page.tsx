...
export default function ReservationDetailsPage({ id }: { id: string }) {
  ...
  const ValueWrapper = ({
    ...
    <div className="flex gap-20 host-page-p2-primary-black">
      {loading ? (
  ...
  return (
    <div className="md:min-w-[1200px] flex flex-col gap-12">
      ...
      <h2 className="host-page-h2-primary-black">Booking Detail</h2>
      <div className="flex justify-between gap-12">
        <div className="flex flex-col gap-8 rounded-md">
          <div className="flex gap-20 host-page-p2-primary-black">
            <div className="host-page-p2-primary-black-bold w-[200px]">
              List Name:
            </div>
          ...
          {statusLabel === "Cancelled" && (
            <div className="flex gap-20 host-page-p2-primary-black capitalize">
              <div className="host-page-p2-primary-black-bold w-[200px]">
                Cancel Reason:
              </div>
              <ValueWrapper loading={loading}>
            ...
            <div className="flex gap-20 host-page-p2-primary-black">
              ...
              <div className="flex gap-4">
                <Button
                  ...
                  className=""
                >
                  <p className="host-neumorphic-text-button text-primary-blue">
                    ✔ Accept Reservation
                  </p>
                </Button>
                <Button
                  ...
                  className=""
                >
                  <p className="host-neumorphic-text-button text-secondary-error">
                    ✖ Decline
                  </p>
                </Button>
              </div>
